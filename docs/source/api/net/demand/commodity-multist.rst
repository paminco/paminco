...
.. autoclass:: CommodityMultiSourceSink
...
.. autosummary::
   ...
   CommodityMultiSourceSink.node_in_comm
   CommodityMultiSourceSink.to_dict
   CommodityMultiSourceSink.get_scaled_copy
   CommodityMultiSourceSink.get_sparse_elements
   CommodityMultiSourceSink.map_node_labels
   CommodityMultiSourceSink.map_node_ids
   CommodityMultiSourceSink.from_label_and_id
